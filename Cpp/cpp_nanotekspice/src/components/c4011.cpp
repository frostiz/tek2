...
nts::c4011::c4011(const std::string &value)
	: _truthtable{
	{nts::Tristate::XUNDEFINED, nts::Tristate::XUNDEFINED, nts::Tristate::XUNDEFINED},
	{nts::Tristate::XUNDEFINED, nts::Tristate::XFALSE,     nts::Tristate::XUNDEFINED},
	{nts::Tristate::XUNDEFINED, nts::Tristate::XTRUE,      nts::Tristate::XFALSE},
	{nts::Tristate::XFALSE,     nts::Tristate::XUNDEFINED, nts::Tristate::XUNDEFINED},
	{nts::Tristate::XFALSE,     nts::Tristate::XFALSE,     nts::Tristate::XTRUE},
	{nts::Tristate::XFALSE,     nts::Tristate::XTRUE,      nts::Tristate::XTRUE},
	{nts::Tristate::XTRUE,      nts::Tristate::XUNDEFINED, nts::Tristate::XFALSE},
	{nts::Tristate::XTRUE,      nts::Tristate::XFALSE,     nts::Tristate::XTRUE},
	{nts::Tristate::XTRUE,      nts::Tristate::XTRUE,      nts::Tristate::XFALSE},
}
{
	(void)value;
...
nts::Tristate		nts::c4011::gate_nand(const nts::Tristate &left, const nts::Tristate &right)
{
	for (int i = 0; i < 9; i++) {
...
nts::Tristate		nts::c4011::compute(size_t pin)
{
	...
	return this->gate_nand(result1, result2);
}

void			nts::c4011::setLink(size_t pin, nts::IComponent &other, size_t otherPin)
{
...
const size_t		&nts::c4011::getPinNumber() const {
	return _pinNumber;
}

const std::string 	&nts::c4011::getType() const {
	return _type;
}
