...
nts::Tristate		nts::c4001::gate_nor(const nts::Tristate &left, const nts::Tristate &right)
{
	for (int i = 0; i < 9; i++) {
...
nts::Tristate		nts::c4001::compute(size_t pin)
{
	...
	return this->gate_nor(result1, result2);
}

void			nts::c4001::setLink(size_t pin, nts::IComponent &other, size_t otherPin)
{
...
const size_t		&nts::c4001::getPinNumber() const {
	return _pinNumber;
}

const std::string 	&nts::c4001::getType() const {
	return _type;
}
