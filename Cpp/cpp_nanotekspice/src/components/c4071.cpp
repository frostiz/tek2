...
nts::c4071::c4071(const std::string &value)
	: _truthtable {
	...
	{nts::Tristate::XUNDEFINED, nts::Tristate::XTRUE, nts::Tristate::XTRUE},
	...
	{nts::Tristate::XTRUE, nts::Tristate::XUNDEFINED, nts::Tristate::XTRUE},
...
nts::Tristate		nts::c4071::gate_or(const nts::Tristate &left, const nts::Tristate &right)
{
	for (int i = 0; i < 9; i++) {
...
nts::Tristate		nts::c4071::compute(size_t pin)
{
	...
	return this->gate_or(result1, result2);
}

void			nts::c4071::setLink(size_t pin, nts::IComponent &other, size_t otherPin)
{
...
const size_t		&nts::c4071::getPinNumber() const {
	return _pinNumber;
}

const std::string 	&nts::c4071::getType() const {
	return _type;
}
